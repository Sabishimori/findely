...
const RAW_GLOBAL_STARTUPS: StartupDef[] = [
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // 🟠 3. Y COMBINATOR BREAKOUT & NEW STARTUPS (YC W24, S24, W25, W23, S23, S22)
  // ════════════════════════════════════════════════════════════════════════════
  {
    name: "Cursor",
    domain: "cursor.com",
    ...
    description: "An AI-powered code editor built on VS Code designed for hyper-productive software engineering [YC S22].",
    roles: [
      { title: "Founding AI Systems Engineer", salary: "$220k - $340k", type: "Full-time" },
      { title: "Core Editor Engineer - Rust / TypeScript", salary: "$200k - $300k", type: "Full-time" },
      { title: "AI Model Alignment & Eval Engineer", salary: "$210k - $320k", type: "Full-time" },
    ],
  },
  {
    name: "Resend",
    ...
    description: "Email infrastructure for developers, built with modern DX and React Email [YC W23].",
    roles: [
      { title: "Founding Backend Engineer (Distributed Systems)", salary: "$180k - $250k", type: "Remote" },
      { title: "Frontend DX Engineer - React / Next.js", salary: "$160k - $220k", type: "Remote" },
    ],
  },
  {
    name: "Decagon",
    ...
    founded: 2023,
    size: "50+ employees",
    founders: [{ name: "Jesse Zhang", role: "CEO" }, { name: "Ashwin Sreenivas", role: "CTO" }],
    techStack: ["Python", "PyTorch", "FastAPI", "React", "LLMs"],
    description: "Generative AI customer experience agents for enterprise support teams [YC W24].",
    roles: [
      { title: "Founding AI Engineer - Agentic Reasoning", salary: "$190k - $270k", type: "Full-time" },
      { title: "Full Stack Engineer - Enterprise Platform", salary: "$170k - $240k", type: "Full-time" },
    ],
  },
  {
    name: "Cartesia",
    ...
    founded: 2024,
    size: "30+ employees",
    founders: [{ name: "Karan Goel", role: "CEO" }],
    techStack: ["Python", "State Space Models", "CUDA", "C++", "Rust"],
    description: "Ultra-low latency real-time voice intelligence powered by state-space models [YC S24].",
    roles: [
      { title: "Research Scientist - Speech & Audio Foundation Models", salary: "$220k - $320k", type: "Full-time" },
      { title: "High-Performance Systems Engineer - CUDA / C++", salary: "$200k - $290k", type: "Full-time" },
    ],
  },
  {
    name: "Retell AI",
    ...
    founded: 2023,
    size: "35+ employees",
    founders: [{ name: "Bingxuan Li", role: "CEO" }, { name: "Evie Wang", role: "Co-Founder" }],
    techStack: ["WebSockets", "Python", "WebRTC", "Node.js", "Go"],
    description: "Conversational voice AI engine with sub-800ms natural latency for developers [YC W24].",
    roles: [
      { title: "Voice AI Systems Engineer (WebRTC / C++)", salary: "$180k - $260k", type: "Full-time" },
      { title: "Full Stack Developer Experience Engineer", salary: "$160k - $230k", type: "Full-time" },
    ],
  },
  {
    name: "Vapi",
    ...
    founded: 2023,
    size: "25+ employees",
    founders: [{ name: "Jordan Fisher", role: "CEO" }],
    techStack: ["TypeScript", "Node.js", "WebRTC", "Python", "LLMs"],
    description: "The voice AI platform for developers to build conversational assistant apps [YC W24].",
    roles: [
      { title: "Lead Distributed Systems Engineer", salary: "$190k - $270k", type: "Full-time" },
      { title: "DevRel & Solutions Architect", salary: "$150k - $210k", type: "Full-time" },
    ],
  },
  {
    name: "Mercor",
    ...
    founded: 2023,
    size: "40+ employees",
    founders: [{ name: "Brendan Foody", role: "CEO" }, { name: "Adarsh Hiremath", role: "CTO" }],
    techStack: ["Next.js", "Python", "PostgreSQL", "TypeScript", "LLMs"],
    description: "AI-driven hiring marketplace connecting top engineering talent with global startups [YC W24].",
    roles: [
      { title: "Senior AI Researcher - Candidate Evaluation Models", salary: "$200k - $280k", type: "Full-time" },
      { title: "Frontend Architect - Next.js", salary: "$170k - $240k", type: "Full-time" },
    ],
  },
  {
    name: "Braintrust",
    ...
    founded: 2023,
    size: "30+ employees",
    founders: [{ name: "Ankur Goyal", role: "CEO" }],
    techStack: ["TypeScript", "Python", "DuckDB", "ClickHouse", "Next.js"],
    description: "Enterprise evaluation, observability, and testing platform for AI applications [YC W23].",
    roles: [
      { title: "Founding Data Infrastructure Engineer", salary: "$190k - $260k", type: "Remote" },
      { title: "Full Stack Engineer - Observability Canvas", salary: "$170k - $230k", type: "Remote" },
    ],
  },
  {
    name: "Krea AI",
    ...
    founded: 2022,
    size: "30+ employees",
    founders: [{ name: "Victor Perez", role: "CEO" }, { name: "Diego Rodriguez", role: "CTO" }],
    techStack: ["WebGL", "WebGPU", "Python", "PyTorch", "React"],
    description: "Real-time generative AI creative canvas for artists, designers, and video creators [YC S22].",
    roles: [
      { title: "WebGPU & Real-Time Graphics Engineer", salary: "$190k - $270k", type: "Full-time" },
      { title: "Generative Video ML Engineer", salary: "$200k - $280k", type: "Full-time" },
    ],
  },
  {
    name: "Luma AI",
    ...
    founded: 2021,
    size: "50+ employees",
    founders: [{ name: "Amit Jain", role: "CEO" }, { name: "Alex Yu", role: "CTO" }],
    techStack: ["NeRF", "Gaussian Splatting", "PyTorch", "CUDA", "C++"],
    description: "Next-generation multimodal video and 3D visual generative AI models (Dream Machine) [YC W21].",
    roles: [
      { title: "Research Scientist - Video World Models", salary: "$240k - $360k", type: "Full-time" },
      { title: "3D Graphics Engine Architect", salary: "$210k - $290k", type: "Full-time" },
    ],
  },
  {
    name: "Daytona",
    ...
    founded: 2023,
    size: "25+ employees",
    founders: [{ name: "Ivan Burazin", role: "CEO" }],
    techStack: ["Go", "Docker", "Kubernetes", "Linux", "TypeScript"],
    description: "Open source standard development environment management platform [YC W24].",
    roles: [
      { title: "Core Platform Engineer (Go / Kubernetes)", salary: "$160k - $220k", type: "Remote" },
      { title: "Developer Advocate - Open Source Ecosystem", salary: "$130k - $180k", type: "Remote" },
    ],
  },
  {
    name: "Magic AI",
    ...
    founded: 2022,
    size: "40+ employees",
    founders: [{ name: "Eric Steinberger", role: "CEO" }],
    techStack: ["Rust", "PyTorch", "Supercomputing", "CUDA", "C++"],
    description: "Frontier AI lab building an ultra-long context AI coworker for software engineering [YC S22].",
    roles: [
      { title: "Frontier LLM Research Scientist", salary: "$280k - $420k", type: "Full-time" },
      { title: "Supercomputing Cluster Engineer", salary: "$230k - $330k", type: "Full-time" },
    ],
  },
  {
    name: "Tavily",
    ...
    founded: 2023,
    size: "20+ employees",
    founders: [{ name: "Assaf Elovic", role: "CEO" }],
    techStack: ["Python", "FastAPI", "Search Ranking", "Web Scraping", "AI Agents"],
    description: "Search engine specifically engineered and optimized for AI agents and LLMs [YC W24].",
    roles: [
      { title: "Search Infrastructure & Crawling Engineer", salary: "$170k - $240k", type: "Remote" },
      { title: "AI Agent Integrations Lead", salary: "$150k - $210k", type: "Remote" },
    ],
  },
  {
    name: "Supermaven",
    ...
    founded: 2024,
    size: "15+ employees",
    founders: [{ name: "Jacob Jackson", role: "CEO" }],
    techStack: ["Rust", "C++", "Transformers", "WebAssembly", "VS Code"],
    description: "Ultra-fast sub-50ms code completion engine with 1-million token context window [YC S24].",
    roles: [
      { title: "High Performance Model Inference Engineer (C++/CUDA)", salary: "$220k - $320k", type: "Full-time" },
    ],
  },
  {
    name: "Langfuse",
    domain: "langfuse.com",
    city: "Berlin, Germany & Remote",
    country: "Germany",
    lat: 52.5200,
    lng: 13.4050,
    founded: 2023,
    size: "20+ employees",
    founders: [{ name: "Clemens Rawert", role: "Co-Founder" }, { name: "Marc Klingen", role: "Co-Founder" }],
    techStack: ["TypeScript", "Next.js", "ClickHouse", "PostgreSQL", "Docker"],
    description: "Open source LLM engineering platform: observability, metrics, evals, prompt management [YC W23].",
    roles: [
      { title: "Full Stack Engineer (TypeScript/Next.js)", salary: "€100k - €140k", type: "Remote" },
      { title: "Database Systems Architect (ClickHouse)", salary: "€110k - €150k", type: "Remote" },
    ],
  },
  {
    name: "Brex",
    ...
    description: "AI-powered spend management and corporate cards for high-growth tech enterprises [YC W17].",
    roles: [
      { title: "Staff Software Engineer - Financial Ledger", salary: "$220k - $290k", type: "Full-time" },
      { title: "Senior Product Designer - Mobile", salary: "$170k - $230k", type: "Full-time" },
    ],
  },
  {
    name: "Deel",
    ...
    description: "Global hiring, compliance, and automated international payroll platform [YC S19].",
    roles: [
      { title: "Senior Backend Engineer - Global Payments", salary: "$160k - $220k", type: "Remote" },
      { title: "Principal Product Manager - Tax Compliance", salary: "$180k - $250k", type: "Remote" },
    ],
  },
  {
    name: "Retool",
    ...
    description: "The fastest way to build custom internal software and workflows for business operations [YC W17].",
    roles: [
      { title: "Staff Engineer - Retool AI & Workflows", salary: "$210k - $280k", type: "Full-time" },
      { title: "Product Designer - Canvas Experience", salary: "$170k - $230k", type: "Full-time" },
    ],
  },
  {
    name: "Stripe",
    ...
    founders: [{ name: "Patrick Collison", role: "CEO" }, { name: "John Collison", role: "President" }],
    techStack: ["Ruby", "Sorbet", "Java", "Go", "React"],
    description: "Financial infrastructure for the internet powering millions of businesses worldwide [YC S09].",
    roles: [
      { title: "Staff Software Engineer - Global Payments Engine", salary: "$240k - $320k", type: "Full-time" },
      { title: "Product Security Engineer", salary: "$200k - $280k", type: "Full-time" },
    ],
  },
  {
    name: "GitLab",
    ...
    description: "The complete DevSecOps platform delivered as a single application [YC W15].",
    roles: [
      { title: "Senior Fullstack Engineer - AI Assisted", salary: "$160k - $220k", type: "Remote" },
      { title: "Staff Backend Engineer - CI/CD Scale", salary: "$180k - $250k", type: "Remote" },
    ],
  },
  {
    name: "Zapier",
    ...
    description: "Workflow automation tool connecting over 6,000+ business applications seamlessly [YC S12].",
    roles: [
      { title: "Senior Full Stack Engineer - AI Automation", salary: "$170k - $230k", type: "Remote" },
    ],
  },
  {
    name: "InVideo",
    domain: "invideo.io",
    city: "San Francisco, CA & Mumbai",
    country: "United States",
    lat: 37.7749,
    lng: -122.4194,
    founded: 2019,
    size: "200+ employees",
    founders: [{ name: "Sanket Shah", role: "CEO" }, { name: "Pankit Goyal", role: "CTO" }],
    techStack: ["WebGL", "WebAssembly", "Python", "Next.js", "AI Video"],
    description: "AI video generation and editing platform converting text prompts to publish-ready video [YC W21].",
    roles: [
      { title: "Lead AI Video Research Engineer", salary: "$180k - $250k", type: "Full-time" },
      { title: "Senior WebGL Graphics Engineer", salary: "$150k - $210k", type: "Full-time" },
    ],
  },
  {
    name: "Novu",
    ...
    founded: 2021,
    size: "30+ employees",
    founders: [{ name: "Nevo David", role: "Co-Founder" }, { name: "Dima Grossman", role: "Co-Founder" }],
    techStack: ["TypeScript", "NestJS", "React", "Redis", "MongoDB"],
    description: "Open source notification infrastructure built for modern engineering teams [YC S22].",
    roles: [
      { title: "Founding Backend Engineer (TypeScript / NestJS)", salary: "$150k - $210k", type: "Remote" },
    ],
  },
  {
    name: "Codeium",
    ...
    founded: 2021,
    size: "60+ employees",
    founders: [{ name: "Varun Mohan", role: "CEO" }, { name: "Douglas Chen", role: "Co-Founder" }],
    techStack: ["C++", "CUDA", "Python", "TypeScript", "LLMs"],
    description: "Modern generative AI code acceleration and enterprise in-IDE assistant [YC W21].",
    roles: [
      { title: "High Performance ML Systems Engineer", salary: "$220k - $320k", type: "Full-time" },
      { title: "Compiler & IDE Integration Engineer", salary: "$190k - $270k", type: "Full-time" },
    ],
  },
