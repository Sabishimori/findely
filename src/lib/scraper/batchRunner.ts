...
export interface CompanyTarget {
  name: string;
  domain: string;
  atsType: "greenhouse" | "lever" | "ashby" | "workday" | "smartrecruiters";
  boardId: string;
  workdayHost?: string;
  workdayPath?: string;
  logoUrl?: string;
...
export const TARGET_FRONTIER_STARTUPS: CompanyTarget[] = [
  ...
  },
  {
    ...
    founders: [{ name: "Girish Mathrubootham", role: "Founder" }, { name: "Shan Krishnasamy", role: "Co-Founder" }],
    techStack: ["Ruby on Rails", "Java", "React", "AWS", "TypeScript"],
    primaryCountry: "India",
    primaryCity: "Chennai",
  },
  {
    ...
    techStack: ["Java", "HBase", "Aerospike", "Kafka", "React Native"],
    primaryCountry: "India",
    primaryCity: "Bengaluru",
  },
  {
    ...
    founders: [{ name: "Sriharsha Majety", role: "CEO" }, { name: "Nandan Reddy", role: "Co-Founder" }],
  ...
  },
  {
    ...
    techStack: ["Microservices", "Java", "Go", "React", "GCP"],
    primaryCountry: "India",
    primaryCity: "Bengaluru",
  },
  {
    ...
    techStack: ["Kotlin", "Go", "React Native", "AWS", "Kafka"],
    primaryCountry: "India",
    primaryCity: "Bengaluru",
  },
  {
    ...
    techStack: ["Solidity", "Go", "Rust", "ZK-Rollups", "TypeScript"],
    primaryCountry: "India",
    primaryCity: "Bengaluru",
  },
  ...
  },
  {
    ...
    techStack: ["CUDA", "C++", "Python", "GPU Cloud", "Kubernetes"],
    primaryCountry: "United States",
    primaryCity: "San Francisco",
  },
  {
    ...
    techStack: ["C++", "Embedded Systems", "Robotics", "Python", "Real-Time OS"],
    primaryCountry: "United States",
    primaryCity: "Long Beach",
  },
  {
    name: "Retool",
    domain: "retool.com",
  ...
  },
  {
    ...
    founders: [{ name: "Alex Bouaziz", role: "CEO" }, { name: "Shuo Wang", role: "CRO" }],
  ...
  },
  {
    ...
    foundedYear: 2014,
    companySize: "2,000+ employees",
    founders: [{ name: "Sid Sijbrandij", role: "Co-Founder" }],
  ...
  },
  {
    ...
    founders: [{ name: "Tom Blomfield", role: "Founder" }, { name: "TS Anil", role: "CEO" }],
    techStack: ["Go", "Kubernetes", "Cassandra", "React", "Kafka"],
  ...
  },
  {
    ...
    foundedYear: 2010,
    companySize: "1,500+ employees",
    founders: [{ name: "Demis Hassabis", role: "CEO" }, { name: "Shane Legg", role: "Chief Scientist" }],
    techStack: ["JAX", "PyTorch", "TensorFlow", "C++", "Python"],
    primaryCountry: "United Kingdom",
    primaryCity: "London",
  },

  // ── 4. ASIA-PACIFIC STARTUPS ───────────────────────────────────
  {
    name: "Canva",
    domain: "canva.com",
    atsType: "smartrecruiters",
  ...
  },
  {
    ...
    atsType: "greenhouse",
    boardId: "daangn",
    logoUrl: "https://logo.clearbit.com/daangn.com",
    foundedYear: 2015,
    companySize: "500+ employees",
    founders: [{ name: "Gary Kim", role: "Co-Founder" }, { name: "Paul Kim", role: "Co-Founder" }],
    techStack: ["Ruby", "TypeScript", "Go", "AWS", "React Native"],
  ...
  },
  {
    ...
    techStack: ["Go", "Python", "C++", "Kubernetes", "React"],
    primaryCountry: "China",
    primaryCity: "Beijing",
  },

  // ── 5. WORKDAY TECH POWERHOUSES ────────────────────────────────
  {
    name: "Autodesk",
    domain: "autodesk.com",
    atsType: "workday",
